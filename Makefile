...
SRCS = main.cpp server.cpp client.cpp socketUtils.cpp utils.cpp commands.cpp nickCommand.cpp userCommand.cpp passCommand.cpp joinCommand.cpp channel.cpp pingCommand.cpp pongCommand.cpp whoCommand.cpp
